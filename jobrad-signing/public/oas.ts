	...
	"components": {
		...
		"schemas": {
			"Contract": {
				...
				"required": ["vendor", "price", "done", "phone"]
			},
			"Addressee": {
			...
			"EventType": {
				...
				"required": ["name", "category", "owning_application", "schema"],
				"properties": {
					"name": {
					...
					"audience": {
						"type": "string",
						"x-extensible-enum": ["component-internal", "business-unit-internal", "company-internal", "external-partner", "external-public"],
					...
					"category": {
						...
						"type": "string",
						"x-extensible-enum": ["data", "general"]
					},
					"compatibility_mode": {
						"description": "The compatibility mode to evolve the schema.\n",
						"type": "string",
						"x-extensible-enum": ["compatible", "forward", "none"],
						"default": "forward"
					},
					"schema": {
